    ...
    public class CatalogSearchPageViewModel : CatalogPageViewModelBase, IRestorable
    {
        ...
        public async void Search()
        {
            ...
            try
            {
                ...
                var res1 = new ObservableCollection<CatalogItemModel>(result.OfType<CatalogBookItemModel>());
                var res2 = new ObservableCollection<CatalogFolderModel>(result.OfType<CatalogFolderModel>());
                var res3 = res2;
                res3 = null;
                FolderItems = new ObservableCollection<CatalogItemModel>(res1);
                UpdateCanLoadMore();
            }
